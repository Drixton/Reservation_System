...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-JN6N9Jh7nC4cx5dyry5bq8Ylr9WZLdZTr+EqhN7LyBC41f1Xe9VrWMV8g2Lg+1w1zQyKLH0UhBAd8eqGuhRxvg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<table id="sportTable">
    <thead>
        <tr>
            ...
            <th>Time out</th>
            <th>Amount</th>
            <th></th> <!-- Empty column for the "View Details" button -->
        </tr>
    </thead>
    <tbody>
