...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['new-qrcode']['name'])) {
        ...
        $select_sql = "SELECT id FROM gcash_qr_images WHERE id = 1";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $update_sql = "UPDATE gcash_qr_images SET image_path = ? WHERE id = 1";
            ...
            $image_path = $upload_directory . $new_qr_image; // Complete path to the new image
            $insert_sql = "INSERT INTO gcash_qr_images (id, image_path) VALUES (1, ?)";
