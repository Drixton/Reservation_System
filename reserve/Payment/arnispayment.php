            ...
            <div class="flex-container">
                ...
                <h2>Payment Confirmation</h2>
                    ...
                    <div class="detail-item">
                        ...
                        <p class="reservation-note" style="color: blue;">Note: Your payment must cover at least 50% of the total amount of the reservation fee, which is not refundable. The full payment should be made at the counter area at AEP.</p>
                    </div>
                </div>
            </div>
