    ...
    <div class="paywall-container">
        <form method="post" enctype="multipart/form-data">
            <div class="flex-container">
                <div class="section">
                    ...
                    <div class="detail-item">
                        ...
                        <input type="text" id="sport" name="sport" value="Events" readonly>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        <label for="court_number">Facility Number:</label>
            ...
            <div class="section">
                ...
                <button type="button" class="back-button" onclick="window.location.href='../calendar/wholevenue.php'">Back</button>
            </div>
        </form>
    </div>
