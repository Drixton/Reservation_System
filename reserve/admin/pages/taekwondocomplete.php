            ...
            <table id="sportTable">
                ...
                <tbody>
                    ...
                    if (isset($_POST['delete_submit'])) {
                        ...
                        $sql_select = "SELECT * FROM taekwondopage WHERE id = $delete_id";
                        ...
                        if ($result_select->num_rows > 0) {
                            ...
                            $delete_sql = "DELETE FROM taekwondopage WHERE id = $delete_id";
