            ...
            <table id="sportTable">
                ...
                <tbody>
                    ...
                    if (isset($_POST['delete_submit'])) {
                        ...
                        $sql_select = "SELECT * FROM billiardpage WHERE id = $delete_id";
                        ...
                        if ($result_select->num_rows > 0) {
                            ...
                            $delete_sql = "DELETE FROM billiardpage WHERE id = $delete_id";
