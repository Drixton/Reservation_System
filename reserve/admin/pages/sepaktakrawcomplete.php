...
<body class="bg-content">
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid px-4">
            ...
            <h1>Sepak Takraw Reservation</h1>
            <table id="sportTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    if (isset($_POST['delete_submit'])) {
                        ...
                        $sql_select = "SELECT * FROM sepaktakrawpage WHERE id = $delete_id";
                        ...
                        if ($result_select->num_rows > 0) {
                            ...
                            $delete_sql = "DELETE FROM sepaktakrawpage WHERE id = $delete_id";
                    ...
                    $sql = "SELECT * FROM sepaktakrawpage";
