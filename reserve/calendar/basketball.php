...
if ($_SESSION['status'] != 'valid') {
    ...
    exit();
        ...
        <head>
            ...
            <title>Basketball Reservation</title>
...
#sportSelection {
    ...
    <div class="image-placeholder-container">
        <img src="../assets/img/basketball.jpg" alt="Image Placeholder" class="img-fluid">
    </div>
</div>
<div class="col-lg-4">
                    <!-- Time buttons -->
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (exists) {
                ...
                window.location.href = "../Payment/basketballpayment.php" +
