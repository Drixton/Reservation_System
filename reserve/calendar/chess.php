...
#sportSelection {
    ...
    <div class="image-placeholder-container">
        <img src="../assets/img/chess.jpg" alt="Image Placeholder" class="img-fluid">
    </div>
</div>
<div class="col-lg-4">
                    <!-- Time buttons -->
                    ...
                    <!-- Court Selection -->
                        <div class="court-selection-container mt-3">
                            ...
                            <option value="Chess Board 2">Chess Board 2</option>
                            <option value="Chess Board 3">Chess Board 3</option>
