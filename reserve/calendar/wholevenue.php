...
#sportSelection {
    ...
    <div class="image-placeholder-container">
        <img src="../assets/img/wholevenue.jpg" alt="Image Placeholder" class="img-fluid">
    </div>
</div>
<div class="col-lg-4">
                    <!-- Time buttons -->
...
<!-- Add more sports as needed -->
                            ...
                            <div class="additional-options-container mt-3">
                                ...
                                <div class="additional-option" onclick="selectDuration(this)">8 hours</div>
                                <div class="additional-option" onclick="selectDuration(this)">12 hours</div>
                                <div class="additional-option" onclick="selectDuration(this)">16 hours</div>
                                <div class="additional-option" onclick="selectDuration(this)">20 hours</div>
