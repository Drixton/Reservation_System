       ...
       .back-button {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Dart Reservation</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="court-selection-container mt-3">
                        <div class="duration-text">Board SELECTION</div>
                        <select id="courtSelection" class="form-select" onchange="updateCourtNumber(this)">
                            <option value="dart board 3">Dart board 3</option>
                            <option value="dart board 1">Dart board 1</option>
                            <option value="dart board 2">Dart board 2</option>
...
window.location.href = "../Payment/dartpayment.php" + 
...
function selectTime(button) {
    ...
    function updateButtonStyling(timeData) {
        ...
        timeButtons.forEach(button => {
            const timeInfo = timeData.find(item => item.time === button.textContent && item.court_number === 'dart board 3');
            if (timeInfo) {
                button.style.backgroundColor = 'red';
            }
        });
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'dart board 1') {
                window.location.href = 'dartboard1.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'dart board 2') {
                window.location.href = 'dartboard2.php'; // Redirect to arniscourt3.php
            }
        }
