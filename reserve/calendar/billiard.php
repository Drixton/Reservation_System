...
<body>
            ...
            <div class="col-lg-4">
                ...
                <div class="court-selection-container mt-3">
                    ...
                    <select id="courtSelection" class="form-select" onchange="updateCourtNumber(this)">
                        <option value="Billiard Table 1">Billiard Table 1</option>
                        <option value="Billiard Table 2">Billiard Table 2</option>
                        <option value="Billiard Table 3">Billiard Table 3</option>
                        <option value="Billiard Table 4">Billiard Table 4</option>
                        <option value="Billiard Table 5">Billiard Table 5</option>
    ...
    <SCript>
        ...
        // $(document).on('change','#currentDateDisplay',function(){
        //     alert('yes');
        // })
    ...
    <script>
        ...
        function disabled_time_slots(date) {
            ...
            $.ajax({
                type: 'GET',
                url: 'booked_time.php?date=' + date + '&&sports=Billiard',
                processData: false,
                contentType: false,
