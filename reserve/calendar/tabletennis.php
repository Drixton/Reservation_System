...
#sportSelection {
    ...
    <div class="image-placeholder-container">
        <img src="../assets/img/tabletennis.jpg" alt="Image Placeholder" class="img-fluid">
    </div>
</div>
<div class="col-lg-4">
                    <!-- Time buttons -->
                    ...
                    <!-- Court Selection -->
                        <div class="court-selection-container mt-3">
                            ...
                            <option value="Tennis Table 1">Tennis Table 1</option>
                            <option value="Tennis Table 2">Tennis Table 2</option>
                            <option value="Tennis Table 3">Tennis Table 3</option>
                            <option value="Tennis Table 4">Tennis Table 4</option>
                            <option value="Tennis Table 5">Tennis Table 5</option>
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (exists) {
                ...
                window.location.href = "../Payment/tabletennispayment.php" +
