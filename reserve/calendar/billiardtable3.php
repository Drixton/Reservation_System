...
function selectTime(button) {
    ...
    function updateButtonStyling(timeData) {
        ...
        timeButtons.forEach(button => {
            const timeInfo = timeData.find(item => item.time === button.textContent && item.court_number === 'table 3');
            if (timeInfo) {
                button.style.backgroundColor = 'red';
            }
        });
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'table 1') {
                window.location.href = 'billiardtable1.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'table 2') {
                window.location.href = 'billiardtable2.php'; // Redirect to arniscourt3.php
            }
        }
