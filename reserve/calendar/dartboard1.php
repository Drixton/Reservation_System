...
function selectTime(button) {
    ...
    function updateButtonStyling(timeData) {
        ...
        timeButtons.forEach(button => {
            const timeInfo = timeData.find(item => item.time === button.textContent && item.court_number === 'dart board 1');
            if (timeInfo) {
                button.style.backgroundColor = 'red';
            }
        });
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'dart board 2') {
                window.location.href = 'dartboard2.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'dart board 3') {
                window.location.href = 'dartboard3.php'; // Redirect to arniscourt3.php
            }
        }
