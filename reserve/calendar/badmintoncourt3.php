...
<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Badminton Reservation</title>
       ...
       .back-button {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Badminton Reservation</a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="court-selection-container mt-3">
                        ...
                        <select id="courtSelection" class="form-select" onchange="updateCourtNumber(this)">
                            <option value="court 2">Court 3</option>
                            <option value="court 1">Court 1</option>
                            <option value="court 3">Court 2</option>
...
function selectTime(button) {
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'court 1') {
                window.location.href = 'badmintoncourt1.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'court 2') {
                window.location.href = 'badmintoncourt2.php'; // Redirect to arniscourt3.php
            }
        }
