...
<!DOCTYPE html>
        ...
        <head>
            ...
            <title>Taekwondo Reservation</title>
       ...
       .back-button {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Taekwondo Reservation</a>
...
window.location.href = "../Payment/taekwondopayment.php" + 
...
function selectTime(button) {
    ...
    function updateButtonStyling(timeData) {
        ...
        timeButtons.forEach(button => {
            const timeInfo = timeData.find(item => item.time === button.textContent && item.court_number === 'court 5');
            if (timeInfo) {
                button.style.backgroundColor = 'red';
            }
        });
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'court 4') {
                window.location.href = 'taekwondocourt4.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'court 6') {
                window.location.href = 'taekwondocourt6.php'; // Redirect to arniscourt3.php
            }
        }
