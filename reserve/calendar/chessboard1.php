       ...
       .back-button {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Chess Reservation</a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="court-selection-container mt-3">
                        ...
                        <select id="courtSelection" class="form-select" onchange="updateCourtNumber(this)">
                            <option value="chess board 1">Chess board 1</option>
...
window.location.href = "../Payment/badmintonpayment.php" + 
...
function selectTime(button) {
    ...
    function updateButtonStyling(timeData) {
        ...
        timeButtons.forEach(button => {
            const timeInfo = timeData.find(item => item.time === button.textContent && item.court_number === 'chess board 1');
            if (timeInfo) {
                button.style.backgroundColor = 'red';
            }
        });
    ...
    function goToPayment() {
        ...
        window.location.href = "../Payment/chesspayment.php" +
            "?date=" + encodeURIComponent(selectedDate) +
            "&time=" + encodeURIComponent(selectedTime) +
            "&duration=" + encodeURIComponent(selectedDuration) +
    ...
    function updateCourtNumber(selectElement) {
            ...
            if (selectedCourt === 'chessboard 2') {
                window.location.href = 'badmintoncourt2.php'; // Redirect to arniscourt2.php
            } else if (selectedCourt === 'chessboard 3') {
                window.location.href = 'badmintoncourt3.php'; // Redirect to arniscourt3.php
            }
        }
